...
# gist.github.com/karpathy/a4166c7fe253700972fcbc77e4ea32c5
import numpy as np
import gym
...
save_path='models-v1/pong-v1.ckpt'
...
#     if True: env.render()
    ...
    if done:
        ...
        # parameter update
        feed = {tf_x: np.vstack(xs), tf_epr: np.vstack(discount_rewards(rs)), tf_y: np.vstack(ys)}
